defmodule Cardo.Helpers.Cover do
  @moduledoc """
  ...
  def project do
    [app: :Cardo,
     ...,
     test_coverage: [tool: Cardo.Helpers.Cover, ignored: [Cardo.Helpers]],
     aliases: aliases]
  end
  ```
  ...
  defp get_results(opts) do
    ...
    %Cardo.Helpers.Cover{rate: rate, not_covered: nc, errors: fail, opts: opts}
  end
  ...
  defp format_results(%Cardo.Helpers.Cover{} = data) do
